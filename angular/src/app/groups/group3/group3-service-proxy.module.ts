...
@NgModule({
    providers: [
        ...
        ApiServiceProxies.FloorsServiceProxy,
        ApiServiceProxies.ApartmentsServiceProxy,
        ApiServiceProxies.EnumeratedTypesServiceProxy,
        ApiServiceProxies.ResidentsServiceProxy,
