...
namespace Selenium.Test.group11
{
    ...
    public class UpdateXE : Load
    {
        ...
        [TestMethod]
        public void Update_XE_With_Empty()
        {
            String Name = "";
            Login();
        ...
        [TestMethod]
        [DataRow("Leadeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee", "Xam", "77H7-77777")]
        //[DataRow("Lead", "Vanggggggggggggggggggggg", "77H7-77777")]
        //[DataRow("Lead", "Vang", "77H7-7777777777777777777")]
        public void Update_XE_With_MaxSize(String Name, String Color,String License_Plate)
        {
            Login();
