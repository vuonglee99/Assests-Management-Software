...
namespace Group14.AbpZeroTemplate.Web.Core.Services.ThietBiVatTu.Dto
{
    public class THIETBIVATTU_DTO
    {
        ...
        public string TBVT_PHU_KIEN_TEN { get; set; }
        public string TBVT_PHU_KIEN_DVT { get; set; }
        public int? TBVT_PHU_KIEN_SO_LUONG { get; set; }
        public string TBVT_PHU_KIEN_GHI_CHU { get; set; }
        ...
        public string TBVT_PCPTBVT_ID { get; set; }
    }
}