...
using Group11.AbpZeroTemplate.Web.Core;
using Group12.AbpZeroTemplate.Web.Core;
using Group13.AbpZeroTemplate.Web.Core;
using Group14.AbpZeroTemplate.Web.Core;
using Group15.AbpZeroTemplate.Web.Core;
using Group17.AbpZeroTemplate.Web.Core;
...
namespace GSoft.AbpZeroTemplate.Web
{
    [DependsOn(
        ...
        typeof(Group11WebCoreModule),
        typeof(Group12WebCoreModule),
        typeof(Group13WebCoreModule),
        typeof(Group14WebCoreModule),
        typeof(Group15WebCoreModule),
        typeof(Group17WebCoreModule)
    )]
