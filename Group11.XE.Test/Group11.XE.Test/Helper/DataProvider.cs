...
namespace Group11.XE.Test.Helper
{
    class DataProvider
    {
        ...
        string conection = "Server=k21.phanmemquanlytaisan.com;Initial Catalog=db_uit_k21;Persist Security Info=True;User ID=k21;Password=4198Vq/M;MultipleActiveResultSets=False;TrustServerCertificate=True;Connection Timeout=30;";
